package com.lenovo.example.movieapp.sync;
...
import com.lenovo.example.movieapp.R;
...
public class MoviesSyncAdapter extends AbstractThreadedSyncAdapter {
        ...
        try {
            ...
            if( reviewArray.length() > 0){
                for(int i = 0; i < 1; i++){
                    ...
                    reviewValue.put(MovieContract.ReviewEntry.COLUMN_AUTHOR, author);
                    reviewValue.put(MovieContract.ReviewEntry.COLUMN_REVIEW, review);
                    reviewValue.put(MovieContract.ReviewEntry.COLUMN_REVIEW_ID, reviewId);
                    ...
                    getContext().getContentResolver().insert(MovieContract.ReviewEntry.CONTENT_URI, reviewValue);
                ...
                reviewValue.put(MovieContract.ReviewEntry.COLUMN_AUTHOR, ".");
                reviewValue.put(MovieContract.ReviewEntry.COLUMN_REVIEW, "Not Available");
                reviewValue.put(MovieContract.ReviewEntry.COLUMN_REVIEW_ID, "Not Available");
                reviewValue.put(MovieContract.ReviewEntry.COLUMN_MOVIE_ID, movieId);
        ...
        try {
            ...
            if(videoArray.length() > 0){
                for(int i = 0; i < 1; i++){
                    ...
                    videoValue.put(MovieContract.VideoEntry.COLUMN_ADDRESS, key);
                    videoValue.put(MovieContract.VideoEntry.COLUMN_MOVIE_NAME, name);
                    videoValue.put(MovieContract.VideoEntry.COLUMN_VIDEO_ID, videoId);
                    videoValue.put(MovieContract.VideoEntry.COLUMN_MOVIE_ID, movieId);

                    getContext().getContentResolver().delete(MovieContract.VideoEntry.CONTENT_URI,
                            MovieContract.VideoEntry.COLUMN_MOVIE_ID + " = ?",
                            new String[]{Integer.toString(movieId)});

                    getContext().getContentResolver().insert(MovieContract.VideoEntry.CONTENT_URI, videoValue);
                }
            }else{
                ContentValues videoValue = new ContentValues();
                videoValue.put(MovieContract.VideoEntry.COLUMN_ADDRESS, "Not Available");
                videoValue.put(MovieContract.VideoEntry.COLUMN_MOVIE_NAME, "Not Available");
                videoValue.put(MovieContract.VideoEntry.COLUMN_VIDEO_ID, "Not Available");
                videoValue.put(MovieContract.VideoEntry.COLUMN_MOVIE_ID, movieId);
    ...
    private ArrayList<Integer> getMoviesDataFromJson(String moviesJsonStr)
        ...
        try {
            ...
            for(int i = 0; i < moviesArray.length(); i++){
                ...
                movieValues.put( MovieContract.MoviesEntry.COLUMN_IMAGE_PATH, image);
                movieValues.put( MovieContract.MoviesEntry.COLUMN_MOVIE_NAME, title);
                movieValues.put( MovieContract.MoviesEntry.COLUMN_MOVIE_OVERVIEW, overview);
                movieValues.put( MovieContract.MoviesEntry.COLUMN_RELEASE_DATE, releaseDate);
                movieValues.put( MovieContract.MoviesEntry.COLUMN_VOTE_AVERAGE, voteAverage);
                movieValues.put( MovieContract.MoviesEntry.COLUMN_MOVIE_ID, movieID);
                movieValues.put( MovieContract.MoviesEntry.COLUMN_FAVORITE, 0);
     ...
     *  Note that you have to add Android Mainfest sync and authenticator parameters
     * @param context The context used to access the account service
